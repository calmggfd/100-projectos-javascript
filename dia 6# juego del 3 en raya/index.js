...
function    resetGame(){
    for(i   =   0;  i   <   span.length;    i++){
        ...
        span[i].innerHTML   =   "&nsbsp;";
    }
    playerTurn  =   "x";
}

function    gameOver(a){
    var gameOverAlertElement    =   "<b>GAME    OVER    </b><br><br>    player  "   +   span[a].dataset.player.toUpperCase()    +   "Win    !!! <br><br>    "   +   restarButton;
    var div =document.createElement("div");
    div.className   =   "alert";
    div.innerHTML   =   gameOverAlertElement;
    document.getElementByIdTagName("body")[0].appenChild(div);
    window.isGameOver   =   true;
    moves   =   0;
}

function    draw(){
    var drawAlertElement    =   "<b>DRAW!!!</b><br><br>"    +   restarButton;
    var div =   document.createElement("div");
    div.className   =   "alert";
    div.innerHTML   =   drawAlertElement;
    document.getElementByTagName("body")[0].appenChild(div);
    window.isGameOver   =   true;
    moves   =   0;
